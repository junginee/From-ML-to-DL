...
x = datasets.data
y = datasets.target
print('before',x.shape) #before (20640, 8)
...
x = np.delete(x,[3,4],axis=1) #after (20640, 6)
print('after',x.shape) 
...
print(model1,':' ,round(acc1,4))  
print(model2,':', round(acc2,4))  
print(model3,':', round(acc3,4)) 
print(model4,':', round(acc4,4))  

#column drop 전
# DecisionTreeRegressor() : 0.6225
# RandomForestRegressor() : 0.8219
# GradientBoostingRegressor() : 0.8005
# XGBRegressor : 0.8433

#column drop 후
# DecisionTreeRegressor() : 0.6271
# RandomForestRegressor() : 0.8221
# GradientBoostingRegressor() : 0.8005
# XGBRegressor : 0.8433