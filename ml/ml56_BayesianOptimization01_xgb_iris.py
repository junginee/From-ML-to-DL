...
x_train, x_test, y_train, y_test = train_test_split(
    x, y, random_state=72, train_size=0.8
)
...
#{'target': 1.0, 'params': {'colsample_bylevel': 0.9811757745519296, 'colsample_bynode': 0.687336920288659, 'colsample_bytree': 0.020551701851451457, 'gamma': 
# 9.540058882987502, 'max_depth': 4.078755886054916, 'min_child_weight': 14.641514217210583, 'reg_alpha': 8.778226259896604, 'reg_lambda': 0.25571787371781146, 
# 'subsample': 0.9264606050753644}}
