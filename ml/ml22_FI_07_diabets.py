...
x = datasets.data
y = datasets.target
print('before',x.shape) #before (442, 10)
...
x = np.delete(x,[1,7],axis=1) #after (442, 8)
print('after',x.shape) 
...
print(model1,':' ,round(acc1,4))  #DecisionTreeRegressor() : -0.2343
print(model2,':', round(acc2,4))  #RandomForestRegressor() : 0.3828
print(model3,':', round(acc3,4))  #GradientBoostingRegressor() : 0.3891
print(model4,':', round(acc4,4))  #XGBRegressor() : 0.238
