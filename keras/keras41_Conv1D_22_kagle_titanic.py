...
from tensorflow.python.keras.layers import Dense,Dropout,Input,Flatten, Conv1D
...
print(x_train.shape,x_test.shape) #(623, 8) (268, 8)

scaler = MinMaxScaler()
x_train = scaler.fit_transform(x_train)
x_test = scaler.transform(x_test)
test_set = scaler.transform(test_set)        
x_train = x_train.reshape(623,4,2)
x_test = x_test.reshape(268,4,2)                                       
