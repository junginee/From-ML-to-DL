...
print(x1.shape, y1.shape)  #(69, 5, 8) (69, 1)
print(x2.shape, y2.shape)  #(69, 5, 8) (69, 1)


# 1-10. 데이터 reshape
x1_train, x1_test, x2_train, x2_test, y1_train, y1_test, y2_train, y2_test = train_test_split(
    x1, x2, y1, y2, train_size=0.7, shuffle=False, random_state=66)
...
mcp = ModelCheckpoint(monitor='val_loss', mode = 'auto', verbose=1,
                      save_best_only=True,
                      filepath="".join([filepath + 'k46',date,'_',filename])) 
...
model.save('./_ModelCheckPoint/k46.hdf5')
...
print('22-07-19 시가 :', predict[-1:],'원') 


#k460719_1214_0027-136758.1094
# loss : [119664.7109375, 14334245888.0]
# 22-07-19 시가 : [[12762.122]] 원
