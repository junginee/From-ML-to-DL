...
print(x_train.shape,x_test.shape) #(1257, 8, 8) (540, 8, 8)


#2.모델구성
model = Sequential()
model.add(LSTM(64, return_sequences = True, input_shape=(8,8))) 
model.add(LSTM(7,activation='relu'))
model.add(Dense(7,activation='relu'))
model.add(Dense(32, activation='relu'))
model.add(Dense(32, activation='relu'))
model.add(Dense(10,activation='softmax')) #y의 라벨 10개
