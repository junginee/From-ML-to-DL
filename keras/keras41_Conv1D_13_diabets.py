...
from tensorflow.python.keras.layers import Dense, Input, Flatten, Conv1D
...
x_train = x_train.reshape(309, 2, 5) 
x_test = x_test.reshape(133, 2, 5)
print(x_train.shape)    
...
#2. 모델 구성
model = Sequential()
model.add(Conv1D(64,2, input_shape=(2, 5)))  
model.add(Flatten())        
...
# loss :  2980.661865234375
# r2 스코어:  0.5024657855456242
#=================================================================================#

#================================= 3. [CONV1]loss, accuracy ========================#
# loss :  2481.290771484375
# r2 스코어:  0.5858211509054494
#=================================================================================#