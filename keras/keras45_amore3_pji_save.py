...
dense2 = Dense(12, activation='relu', name = 'dense2')(dense1)
dense3 = Dense(8, activation='relu', name = 'dense3')(dense2)
dense4 = Dense(8, activation='relu', name = 'dense4')(dense3)
output1 = Dense(13, name = 'output1')(dense4)

# 2-2. 2번 모델구성(2)
input2 = Input((3,7))
dense11 = LSTM(10, activation='relu', name = 'dense11')(input2)
dense12 = Dense(5, activation='relu', name = 'dense12')(dense11)
dense13 = Dropout(0.3, name = 'dense13')(dense12)
dense14 = Dense(14, activation='relu', name = 'dense14')(dense13)
dense15 = Dropout(0.2, name = 'dense15')(dense14)
dense16 = Dense(15, activation='relu', name = 'dense16')(dense15)
output2 = Dense(10, name = 'output11')(dense16)
...
# 3. 컴파일, 훈련
# filepath = './__ModelCheckpoint/amore/'
...
model.fit([x1_train_scale,x2_train_scale],y2_train, epochs=600, batch_size=12, 
          validation_split=0.3, 
          callbacks=[es
                     #,mcp
                     ])

model.save('./_test/amore/k46(6).hdf5')
...
# './_test/amore/k46.hdf5'
# loss : [19579.63671875, 452815104.0]
# 22-07-20 종가 : [145538.84] 원

# './_test/amore/k46(2).hdf5'
# loss : [50345.703125, 2735122432.0]

# 22-07-20 종가 : [120195.71] 원

# './_test/amore/k46(3).hdf5' 
# loss : [43049.3046875, 2034256128.0]
# 22-07-20 종가 : [140351.03] 원

# './_test/amore/k46(4).hdf5'
# loss : [42245.8203125, 2112945152.0]
# 22-07-20 종가 : [138306.12] 원

# './_test/amore/k46(5).hdf5'
# loss : [35731.84375, 1391336832.0]
# 22-07-20 종가 : [133415.05] 원