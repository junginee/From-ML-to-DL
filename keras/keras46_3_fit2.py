...
xy_train = train_datagen.flow_from_directory(
    'd:/study_data/data/image/brain/train/',
    target_size=(200,200),
    batch_size=5,
    class_mode = 'binary',
...
xy_test = test_datagen.flow_from_directory(
    'd:/study_data/sata/image/brain/test/',
...
# model.fit(xy_train[0][1], xy_train[0][1]) 
# 만약 배치를 최대로 잡았다면 이 표현도 가능
# 만약, batch_size를 데이터 수 보다 많게 할 경우 [0]으로 지정하며 한 덩어리로 들어간다.
