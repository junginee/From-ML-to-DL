...
# model_list = [model_01, model_04]
# for i in model_list:
#     i.compile(optimizer='adam', loss='binary_crossentropy') 
#     i.fit(x_train, x_train, epochs=10)
#     i.output= i.predict(x_test)
...
random_imgs = random.sample(range(output_04.shape[0]), 5)
